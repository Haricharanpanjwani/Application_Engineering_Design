...
<body>
	...
	<form action="orderRequestDispenser.htm">
		<table class="t13" cellpadding="5" cellspacing="5" align="center">
			<tr>
			...
			<tr>
				...
				<td><select name="dis" onchange="getData(this.value)">
						...
						<c:forEach var="d" items="${dislist}">
							...
							<option value="${d.enterpriseId}"><c:out
									value="${d.enterpriseName}" /></option>
