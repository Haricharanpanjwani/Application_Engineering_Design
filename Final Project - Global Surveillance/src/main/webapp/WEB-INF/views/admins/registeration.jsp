...
<body>
	<form method="post" action="registerationSuccess.htm">
		...
		<table class="register" cellpadding="5" cellspacing="2" align="center">
			<tr>
				<td colspan="2" align="center">Welcome : ${user.getUserName()} </td>
			</tr>
			<tr>
				<td colspan="2" align="center">Register UserAccount</td>
			</tr>
			<tr>
				<td align="left"><input type="radio" value="Manufacturer" name="role" checked="checked">Manufacturer</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" id="button" value="Register" onclick="return validateForm()">
		</table>
	</form>
</body>
</html>