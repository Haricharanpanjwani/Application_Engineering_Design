...
public class PrescriptionPanel extends javax.swing.JPanel {
    ...
    //private ArrayList<String> labTest;
    /**
     * Creates new form ProcessRequestPanel
     */
    public PrescriptionPanel(JPanel userProcessContainer, UserAccount account, WorkRequest request, Enterprise enterprise, String disease) {
        initComponents();
        ...
        prescriptionTabbedPane.setEnabledAt(1, false);
    ...
    private void initComponents() {
        ...
        prescriptionTabbedPane = new javax.swing.JTabbedPane();
        ...
        prescriptionTabbedPane.addTab("Medication", jPanel1);
        ...
        prescriptionTabbedPane.addTab("Lab Test", jPanel2);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(prescriptionTabbedPane)
                .addContainerGap())
        );
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        if (quantTextField.getText().trim().isEmpty() && quant2TextField.getText().trim().isEmpty()
            ...
            prescriptionTabbedPane.setEnabledAt(1, true);
            prescriptionTabbedPane.setSelectedIndex(1);
            prescriptionTabbedPane.setEnabledAt(0, false);
    ...
    private void sendBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendBtnActionPerformed
        ...
        if (flag == 0) {
            ...
            labRequest.setPatient(((UserPriviligeWorkRequest) request).getPatient());
...
//        layout.next(userProcessContainer);
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        prescriptionTabbedPane.setEnabledAt(1, false);
        prescriptionTabbedPane.setSelectedIndex(0);
        prescriptionTabbedPane.setEnabledAt(0, true);
    ...
    private void backBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtn1ActionPerformed
        ...
        ((UserPriviligeWorkRequest) request).getPatient().setDisease(null);
    ...
    private javax.swing.JTabbedPane prescriptionTabbedPane;
