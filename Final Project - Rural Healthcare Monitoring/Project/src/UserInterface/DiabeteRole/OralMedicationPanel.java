 ...
 * @author hpanjwani
 */
public class OralMedicationPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form OralMedicationPanel
     */
    public OralMedicationPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, Patient patient, String level) {
        initComponents();
    ...
    public void populateComboBox() {
        ...
        if (diabeteLevel.equals("Type 1")) {
            ...
            medComboBox.addItem("Acarbose");
            medComboBox.addItem("Cycloset");
            medComboBox.addItem("DiaBeta");
            medComboBox.addItem("Glumetza");

            medComboBox2.addItem("Acarbose");
            medComboBox2.addItem("Cycloset");
            medComboBox2.addItem("DiaBeta");
            medComboBox2.addItem("Glumetza");

            medComboBox3.addItem("Acarbose");
            medComboBox3.addItem("Cycloset");
            medComboBox3.addItem("DiaBeta");
            medComboBox3.addItem("Glumetza");

            medComboBox4.addItem("Acarbose");
            medComboBox4.addItem("Cycloset");
            medComboBox4.addItem("DiaBeta");
            medComboBox4.addItem("Glumetza");

        } else if (diabeteLevel.equals("Type 2")) {

            medComboBox.addItem("Dymelor");
            medComboBox.addItem("Farxiga");
            medComboBox.addItem("Glycron");
            medComboBox.addItem("Janumet");

            medComboBox2.addItem("Dymelor");
            medComboBox2.addItem("Farxiga");
            medComboBox2.addItem("Glycron");
            medComboBox2.addItem("Janumet");

            medComboBox3.addItem("Dymelor");
            medComboBox3.addItem("Farxiga");
            medComboBox3.addItem("Glycron");
            medComboBox3.addItem("Janumet");

            medComboBox4.addItem("Dymelor");
            medComboBox4.addItem("Farxiga");
            medComboBox4.addItem("Glycron");
            medComboBox4.addItem("Janumet");
    ...
    private void initComponents() {
        ...
        submitBtn.setToolTipText("Prescribe medicine");
        ...
        jLabel1.setText("LIST OF ORAL MEDICINES");
