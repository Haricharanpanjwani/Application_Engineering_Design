...
<body>
	<form action="registerSuccess.htm" method="post">
		<p align="center">You Are:
			${sessionScope.userAccount.getUserName()}</p>
		<h3 align="center">ADD USER</h3>
		<table class="error" cellpadding="5" cellspacing="2" align="center">
			<tr>
				<td></td>
			...
			<tr>
				<td></td>
				<td align="left"><input type="radio" value="Distributor"
					name="registerRole">Distributor</td>
			</tr>
			<tr>
				<td></td>
				<td align="left"><input type="radio" value="Dispenser"
					name="registerRole">Dispenser</td>
			</tr>
			<tr>
				<td>First Name</td>
				<td><input id="id1" type="text" name="firstName"
					value="${sessionScope.firstName}"></td>
			</tr>
			<tr>
				<td>Last Name</td>
				<td><input id="id2" type="text" name="lastName"
					value="${sessionScope.lastName}"></td>
			</tr>
			<tr>
				<td>User Name</td>
			...
			<tr>
				...
				<td><input id="id6" type="text" name="enterpriseName"
					value="${sessionScope.enterpriseName}"></td>
			</tr>
			<tr>
				<td>e-Mail Id</td>
			...
			<tr>
				<td>User Address</td>
				<td><input id="id7" type="text" name="address"
