...
//        containsString = @"qa";
//    }
//    else if ([currentEnvironment isEqualToString:@"dev"]) {
//        containsString = @"dev";
//    }
//    else {
...
//    }
//    
//    NSString *expression = [NSString stringWithFormat:@"SELF.login contains '%@dev'", containsString];
//    NSPredicate *predicate = [NSPredicate predicateWithFormat:expression];
//    
//    NSArray *users = [self.usersService.usersMemoryStorage unsortedUsers];
//    NSArray *filteredArray = users; [users filteredArrayUsingPredicate:predicate];
//    
...
- (NSArray *)filteredUsersByCurrentEnvironment {
    ...
    QBUUser *loginUser = [[QBUUser alloc] init];
    
    for(QBUUser *u in users) {
        
        if([u.login isEqualToString:self.ua.username]) {
            loginUser = u;
            break;
        }
    }
    ...
    [mutableUsers addObject:loginUser];
    
    //NSMutableArray *mutableUsers = users;
