...
- (void) encodeWithCoder:(NSCoder *)aCoder {
    [ aCoder encodeObject:self forKey:@"hospital"];
    [ aCoder encodeObject:self.hospitalName forKey:@"hospitalName"];
    [ aCoder encodeObject:self.patientList forKey:@"patientList"];
    [ aCoder encodeObject:self.departmentList forKey:@"departmentList"];
...
- (id) initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self == [self init]) {
        self = [ aDecoder decodeObjectForKey:@"hospital"];
        hospitalName = [ aDecoder decodeObjectForKey:@"hospitalName"];
        patientList  = [ aDecoder decodeObjectForKey:@"patientList"];
        departmentList = [ aDecoder decodeObjectForKey:@"departmentList"];
    }
    return self;
}
