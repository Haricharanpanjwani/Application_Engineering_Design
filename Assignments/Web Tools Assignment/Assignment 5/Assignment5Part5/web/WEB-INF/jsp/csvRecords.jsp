...
<html>
   ...
   <input type="button" value="Display More Records" onclick="return displayMoreRecords();"/>
   
   <script>
       var xmlHttp;
        xmlHttp = GetXmlHttpObject();
        function saveDetails(rowNo) {
        ...
        function displayMoreRecords()
        {
            xmlHttp.onreadystatechange = function stateChanged()
            {
                if (xmlHttp.readyState == 4)
                {
                    ...
                    if (json.salesList.length > 0) {
                    var count=page*100+1;
                    for (var i = 0; i < json.salesList.length; i++) {
                     
                            var y = document.createElement("TR");
                            y.setAttribute("id", "rowNo" + count);
                            ...
                            input.setAttribute("id","salesOrderId"+count);
                            input.setAttribute("value",json.salesList[i].salesOrderId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);

                            var z = document.createElement("TD");
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","revisionNumber"+count);
                            input.setAttribute("value",json.salesList[i].revisionNumber);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","orderDate"+count);
                            input.setAttribute("value",json.salesList[i].orderDate);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","dueDate"+count);
                            input.setAttribute("value",json.salesList[i].dueDate);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","shipDate"+count);
                            input.setAttribute("value",json.salesList[i].shipDate);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","status"+count);
                            input.setAttribute("value",json.salesList[i].status);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","onlineOrderFlag"+count);
                            input.setAttribute("value",json.salesList[i].onlineOrderFlag);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","salesOrderNumber"+count);
                            input.setAttribute("value",json.salesList[i].salesOrderNumber);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","purchaseOrderNumber"+count);
                            input.setAttribute("value",json.salesList[i].purchaseOrderNumber);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","accountNumber"+count);
                            input.setAttribute("value",json.salesList[i].accountNumber);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","customerId"+count);
                            input.setAttribute("value",json.salesList[i].customerId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","salesPersonId"+count);
                            input.setAttribute("value",json.salesList[i].salesPersonId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","territoryId"+count);
                            input.setAttribute("value",json.salesList[i].territoryId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","billToAddressId"+count);
                            input.setAttribute("value",json.salesList[i].billToAddressId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","shipToAddressId"+count);
                            input.setAttribute("value",json.salesList[i].shipToAddressId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","shipMethodId"+count);
                            input.setAttribute("value",json.salesList[i].shipMethodId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","creditCardId"+count);
                            input.setAttribute("value",json.salesList[i].creditCardId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","creditCardApprovalCode"+count);
                            input.setAttribute("value",json.salesList[i].creditCardApprovalCode);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","currencyRateId"+count);
                            input.setAttribute("value",json.salesList[i].currencyRateId);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","subTotal"+count);
                            input.setAttribute("value",json.salesList[i].subTotal);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","taxAmt"+count);
                            input.setAttribute("value",json.salesList[i].taxAmt);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","freight"+count);
                            input.setAttribute("value",json.salesList[i].freight);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","totalDue"+count);
                            input.setAttribute("value",json.salesList[i].totalDue);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","comment"+count);
                            input.setAttribute("value",json.salesList[i].comment);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            var input = document.createElement("input");
                            input.setAttribute("type","text");
                            input.setAttribute("id","modifiedDate"+count);
                            input.setAttribute("value",json.salesList[i].modifiedDate);
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            input.setAttribute("id","rowNo"+count);
                            input.setAttribute("value",count);
                            document.getElementById("rowNo" + count).appendChild(input);
                            
                            var z = document.createElement("TD");
                            var input = document.createElement("input");
                            input.setAttribute("type","submit");
                            input.setAttribute("id","submit"+count);
                            input.setAttribute("value","Save");
                            input.setAttribute("onclick","return saveDetails("+count+");")
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                            ...
                            input.setAttribute("onclick","javascript:deleteRow(this); return false;")
                            z.appendChild(input);
                            document.getElementById("rowNo" + count).appendChild(z);
                    ...
                    {
                        document.getElementById("moreRecords"+page).innerHTML = "Nothing found";
                    }
                }
            };
            xmlHttp.open("GET", "csvdata.htm?action=displaymore", true);
            xmlHttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xmlHttp.send();
            return false;
        }
