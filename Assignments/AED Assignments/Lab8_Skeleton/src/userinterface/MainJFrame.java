...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        //Check if the user account exists at Ecosystem Level
        UserAccount account = system.getUserAccountDirectory().authenticateUser(userName, password);
        Enterprise inEnterprise = null;
        Organization inOrganization  = null;
        
        //if user account was not found at ecosystem level
        if(account == null) {
            
            //Check for network
            for(Network network : system.getNetworkList())  {
                
                //check the user account directory of each enterprise in a network
                for(Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList())   {
                    
                    //authenticate the user at enterprise level
                    account = enterprise .getUserAccountDirectory().authenticateUser(userName, password);
                    
                    //if the user account was not found at enterprise level
                    if(account == null) {
                        
                        // traverse each Organization in the Enterprise
                        for(Organization organization : enterprise.getOrganizationDirectory().getOrganizationList())    {
                            
                            //authenticate the user at organization level
                            account = organization.getUserAccountDirectory().authenticateUser(userName, password);
                            
                            //if the user account was not found at Organization Level
                            if(account != null) {
        ...
        //check if the user account was found in atleast some UserAccountDirectory
        if(account == null) {
            ...
            //Redirect to appropriate workArea
