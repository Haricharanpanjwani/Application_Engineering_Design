...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public void populateEmployeeCombo(Organization org) {
    ...
    public void populateRoleCombo(Organization org)    {
        
        roleJComboBox.removeAllItems();
        
        for(Role role : org.getSupporteRole())
            employeeJComboBox.addItem(role);
    }
    ...
    public void populateData()   {
        ...
        for(Organization org : business.getOrganizationDirectory().getOrganizationList())   {
            for(UserAccount account : org.getUserAccountDir().getUserAccountList())    {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        org.getUserAccountDir().addUserAccount(username, password, emp, role);
        populateData();
